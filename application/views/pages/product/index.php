                            ...
                            <?= form_open(base_url('product/search'), ['method' => 'POST']);?>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm text-center"
                                        placeholder="Cari" name="keyword" value="<?= $this->session->userdata('keyword');?>">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $no; ?></td>
                                    <td>
                                        <p><img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.png");?>" alt="" height="50"><?= $row->product_title;?></p>
                                    </td>
                                    <td>
